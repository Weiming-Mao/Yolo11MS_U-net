...
class Unet(object):
    _defaults = {
        ...
        #-------------------------------------------------------------------#
        "model_path"    : "best_epoch_weights.pth",#'logs/best_epoch_weights.pth'
        #--------------------------------#
        #   所需要区分的类的个数+1
        #--------------------------------#
        "num_classes"   : 3,
    ...
    def __init__(self, **kwargs):
        ...
        if self.num_classes <= 21:
            self.colors = [ (0, 0, 0), (192, 0, 0), (128, 192, 0), (128, 128, 0), (0, 0, 128), (128, 0, 128), (0, 128, 128), 
    ...
    def detect_image(self, image, count=False, name_classes=None):
        ...
        #此处修改image_data  = np.expand_dims(np.transpose(preprocess_input(np.array(image_data, np.float32)), (2, 0, 1)), 0)
        with torch.no_grad():
        ...
        if self.mix_type == 0:
            ...
            #   将新图与原图及进行混合
            #------------------------------------------------#
            image   = Image.blend(old_img, image, 0.4) #原为0.7
